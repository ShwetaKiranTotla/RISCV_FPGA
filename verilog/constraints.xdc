...
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { io19_cell }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]
...
################################
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { gpio_14 }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=ck_io[26]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { gpio_15 }]; #IO_L16N_T2_A15_D31_14 Sch=ck_io[27]
################################
...
#################################
#Added connection of Vout to board pin IO40
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { VOUT }]; #IO_L9N_T1_DQS_D13_14 Sch=ck_io[40]
...
#set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { io19_cell }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]

# Removed Buttons connection and gave it to board pins IO36 to IO39
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { gpio_20 }]; #IO_L8P_T1_D11_14 Sch=ck_io[36]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { gpio_21 }]; #IO_L17P_T2_A14_D30_14 Sch=ck_io[37]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { gpio_22 }]; #IO_L7N_T1_D10_14 Sch=ck_io[38]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { gpio_23 }]; #IO_L7P_T1_D09_14 Sch=ck_io[39]
#################################
